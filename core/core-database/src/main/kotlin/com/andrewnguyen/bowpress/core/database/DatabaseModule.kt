...
object DatabaseModule {
    ...
    @Provides fun provideExportJobDao(db: BowPressDatabase): ExportJobDao = db.exportJobDao()
    ...
    @Provides fun provideAchievementDao(db: BowPressDatabase): AchievementDao = db.achievementDao()
}
